...
AI-powered engineering material selection assistant.
"""
...
estimate, not a verified database match. Write in full, natural sentences rather than
sentence fragments, and vary phrasing between materials rather than repeating the same
...
"""
    ...
    def get_manufacturing_advice(self, material: Dict[str, Any], query: Dict[str, Any]) -> str:
        ...
        prompt = f"""
You are a senior manufacturing engineer advising on production of the following material.
...
class PDFReportGenerator:
    ...
    def generate_comparison_report(
        ...
        # NOTE: original file continues beyond this point (Gemini analysis
        # section, manufacturing section, PageBreak, doc.build(...), and the
        # FastAPI route definitions). Paste the rest of your file so I can
        # finish polishing it in the same style.
